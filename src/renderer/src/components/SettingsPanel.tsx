    ...
    <section className="panel">
      <div className="hud-frame">
        ...
        <div className="settings-form">
          ...
          <p className="section-sub">
            High sarcasm = dry TARS/JARVIS (quality over quantity). High warmth = buddy on the
            line. Voice: “set sarcasm to 90”, “more warmth”. Hit Reset for the latest defaults.
          </p>
          ...
          <button
            type="button"
            className="btn ghost"
            onClick={() => setForm({ ...form, personality: { ...DEFAULT_PERSONALITY } })}
          >
          ...
          <p className="section-sub">
            ...
            granting. When a tool asks Allow/Deny in chat or voice, hit Allow.
          </p>
